...
/**
 * Builder for JDK dynamic proxies that translate interface method calls into {@link Event events} for a
 * {@link StateMachine}.
 * <p>
...
public class StateMachineProxyBuilder {
    ...
    /**
     * Sets whether events that have no handler in the current state should raise an exception or be silently ignored.
     * The default is to raise an exception.
     *
     * @param b <code>true</code> to ignore unhandled events.
     * @return this {@link StateMachineProxyBuilder} for method chaining.
     */
    ...
    /**
     * Creates a proxy for the specified interface backed by the specified {@link StateMachine}.
     *
    ...
    /**
     * Creates a proxy for the specified interfaces backed by the specified {@link StateMachine}.
     * <p>
     * Each method call is converted into an {@link Event}, resolved to a {@link StateContext}, and then dispatched into
     * the state machine.
     * </p>
     *
